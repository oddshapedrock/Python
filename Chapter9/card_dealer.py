...
def card_dealer_main():
    deck = create_deck()
    number_of_cards = input("How many cards would you like to deal? ")
    while not number_of_cards.isnumeric():
        number_of_cards = input("How many cards would you like to deal? ")
    number_of_cards = int(number_of_cards)
    deal_cards(deck, number_of_cards)
...
def deal_cards(deck, number):
    #https://docs.google.com/presentation/d/1ptUn-cJXXG7peK2lNNW_ZKGyBsFxdAaknIVHgB-cvRI/edit#slide=id.g10155dc2ec4_0_0
    cards = []
    value = 0
